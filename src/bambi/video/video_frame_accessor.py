...
from bambi.video.video_domain import VideoInput
from bambi.video.video_writer import OpenCvVideoWriter
...
if __name__ == '__main__':
    ...
    frames = []
    for idx, frame in accessor.access_yield(r"C:\Users\P41743\Desktop\videos\DJI_20230119125528_0004_T.MP4"):
        if idx != 0:
            error = image_equality(prev_frame, frame)
            errors.append(error)
            if error > 0.1:
                frames.append(frame)
        prev_frame = frame
